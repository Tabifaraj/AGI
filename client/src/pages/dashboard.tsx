...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6 max-w-full overflow-hidden">
        <EmergencySection />
        ...
        <Card>
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Family Members</h3>
              <Button
                variant="ghost"
                size="sm"
        ...
        <Card className="ai-assistant-section">
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-200">AI Security Assistant</h3>
                <p className="text-sm text-purple-600 dark:text-purple-300">Listening for voice commands...</p>
              </div>
            </div>
            
            <div className="bg-white/80 dark:bg-gray-800/80 rounded-lg p-4 mb-4">
              <p className="text-base text-gray-700 dark:text-gray-300">"Lock all social media apps for Emma after 8 PM"</p>
            ...
            <Button 
              className="w-full bg-ai-purple hover:bg-purple-700 text-white py-3 text-base"
              size="lg"
        ...
        <Card>
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-6">Quick Actions</h3>
